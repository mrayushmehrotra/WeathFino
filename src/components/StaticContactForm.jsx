        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className={`flex items-center w-full px-5 py-4 rounded-xl bg-gray-50 dark:bg-black/50 border ${errors.mobile ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} text-gray-900 dark:text-white focus-within:ring-2 focus-within:ring-[#D4AF37] focus-within:border-transparent transition-all`}>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-5 py-4 rounded-xl bg-gray-50 dark:bg-black/50 border ${errors.email ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} text-gray-900 dark:text-white focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent transition-all outline-none`}
