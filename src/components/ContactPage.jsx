  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative container mx-auto px-6 py-20 md:py-28">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Let's Connect & Grow
              <span className="block text-blue-200 mt-2">Together</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-full hover:bg-blue-50 transition-all duration-300 flex items-center gap-2">
                <Phone size={18} />
                Call Now
              </button>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-gray-50">
                    <option>Select a topic</option>
                    <option>Investment Consultation</option>
                    <option>Research Report Inquiry</option>
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Send Message
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">SEBI Registered</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">24/7 Response</p>
                    <p className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span className="text-blue-600">sebiero@sebi.gov.in</span>
                </p>
              </div>
            </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-white">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">SEBI Compliant</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-3 z-50">
        <button className="w-14 h-14 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-xl hover:bg-blue-700 transition-all hover:scale-110 group">
          <Phone size={22} />
          <span className="absolute right-full mr-3 bg-blue-600 text-white px-3 py-1 rounded-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
            Call Support
          </span>
        </button>
        <button className="w-14 h-14 rounded-full bg-green-500 text-white flex items-center justify-center shadow-xl hover:bg-green-600 transition-all hover:scale-110 group">
          <MessageCircle size={22} />
          <span className="absolute right-full mr-3 bg-green-500 text-white px-3 py-1 rounded-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
            WhatsApp
          </span>
        </button>
      </div>
