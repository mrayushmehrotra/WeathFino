...
const VideoSection = () => {
  ...
  return (
    <section className="bg-[#0b0d12] py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        {/* TOP TEXT */}
        <div className="text-center mb-12">
          <div className="inline-block px-10 py-4 rounded-xl bg-gradient-to-r from-green-400 to-sky-400">
        ...
        >
          ...
          <button
            onClick={prev}
            className="absolute left-4 z-30 w-10 h-10 rounded-full
            ...
            {videos.map((video, index) => {
              ...
              return (
                <div
                  ...
                  `}
                >
                  <div className="relative w-[340px] md:w-[420px] h-[460px] rounded-2xl overflow-hidden shadow-2xl">
                    <video
                    ...
                    {/* ACTIVE OVERLAY */}
                    {isActive && (
                      <div className="absolute inset-0 bg-black/40 flex flex-col items-center pt-6">
                        ...
                        >
                          <svg
                            ...
                            className="w-5 h-5"
                          >
                            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.016 3.016 0 0 0 .502 6.186 31.247 31.247 0 0 0 0 12a31.247 31.247 0 0 0 .502 5.814 3.016 3.016 0 0 0 2.121 2.136c1.872.505 9.377.505 9.377.505s7.505 0 9.376-.505a3.016 3.016 0 0 0 2.122-2.136A31.247 31.247 0 0 0 24 12a31.247 31.247 0 0 0-.502-5.814ZM9.545 15.568V8.432L15.818 12l-6.273 3.568Z" />
                          </svg>
          ...
          <button
            onClick={next}
            className="absolute right-4 z-30 w-10 h-10 rounded-full
            bg-white/10 hover:bg-white/20 text-white transition"
          >
            →
          </button>
